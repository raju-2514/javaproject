...
public class anothercal extends JFrame implements ActionListener {
 JButton onRadioButton, buttonDot, buttonDelete, buttonClear, buttonZero,
            ...
            buttonConversion, buttonPlus, buttonMinus, buttonOctal, buttonBMR, buttonTemp;
    ...
    anothercal(){
        ...
        buttonTemp = new JButton("Temp");
        buttonTemp.setBounds(80, 410, 60, 40);
        buttonTemp.setFont(new Font("Arial", Font.BOLD, 10));
        ...
        buttonConversion = new JButton("Number Conversion");
        buttonConversion.setBounds(10, 170, 200, 40);
        buttonConversion.setFont(new Font("Arial", Font.BOLD, 15));
        buttonConversion.addActionListener(this);
        add(buttonConversion);

        /* buttonOctal = new JButton("Octl");
        buttonOctal.setBounds(150, 170, 60, 40);
        buttonOctal.setFont(new Font("Arial", Font.BOLD, 10));
        c.add(buttonOctal);

        buttonHexa = new JButton("Hexa");
        buttonHexa.setBounds(80, 170, 60, 40);
        buttonHexa.setFont(new Font("Arial", Font.BOLD, 10));
        c.add(buttonHexa);*/
        ...
        //combobox=new JComboBox(bmr);
        //combobox.setBounds(150, 410, 60, 40);
